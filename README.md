...
**Note**: Very simple monorepo for CI & CD. One key ingredient to enable GitOps is to have the CI separate from CD, so See **[CI/CD GitOps Notes](./README-Notes.md)** for Production-Like Deployment Strategy. 
